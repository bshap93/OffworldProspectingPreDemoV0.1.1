...
{
    public class HealthButtonPromptWithAction : MonoBehaviour
    {
        [Header("Bindings")]
        ...
        public TMP_Text PromptAmountNeededText;
        ...
        public virtual void Show(string key, string action, int amountNeeded)
        {
            gameObject.SetActive(true);
            PromptText.text = key;
            ActionText.text = action;
            PromptAmountNeededText.text = "$" + amountNeeded;
