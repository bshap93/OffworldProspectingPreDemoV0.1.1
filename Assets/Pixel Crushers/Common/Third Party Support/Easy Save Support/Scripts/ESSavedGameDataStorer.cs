...
namespace Pixel_Crushers.Common.Third_Party_Support.Easy_Save_Support.Scripts
{
    /// <summary>
    ...
    public class ESSavedGameDataStorer : SavedGameDataStorer
    {
        ...
        public bool useSeparateFiles;

        [Tooltip(
            "Filename to contain save data, including path. If Use Separate Files is ticked, appends slot number each file.")]
        ...
        public override void StoreSavedGameData(int slotNumber, SavedGameData savedGameData)
        {
            ...
            ES3.Save(GetKey(slotNumber), s, GetFilename(slotNumber));
        }
